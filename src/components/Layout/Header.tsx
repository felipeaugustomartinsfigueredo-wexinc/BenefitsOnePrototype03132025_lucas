...
export const Header: React.FC = () => {
  ...
  const handleLanguageChange = (languageCode: string) => {
    // Sanitize the language code before using it
    const sanitizedCode = DOMPurify.sanitize(languageCode);
    if (languages.some(lang => lang.code === sanitizedCode)) {
      i18n.changeLanguage(sanitizedCode);
      setIsLanguageMenuOpen(false);
    }
  };
