...
import { ChevronDown, Home, Heart, Users, ChevronLeft, ChevronRight, Palette, GitBranch, UserCog, Wallet, Settings as SettingsIcon, FileText, DollarSign, Plus, ListChecks } from 'lucide-react';
...
const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'claims',
        labelKey: 'navigation.claims.title',
        icon: <FileText className="w-5 h-5" />,
        path: '/claims',
        subItems: [
          { id: 'new-claim', labelKey: 'navigation.claims.new', path: '/claims/new' },
          { id: 'view-claims', labelKey: 'navigation.claims.view', path: '/claims/view' },
        ],
      },
      {
        id: 'cobra',
                    ...
                    >
                      ...
                      {!isNavCollapsed && item.subItems && (
                        <button 
                          ...
                          onClick={() => toggleExpand(new MouseEvent('click'), item.id)}
                        >
                          <ChevronDown
